 ...
 */
final class Version20210226053448 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE particulier ADD mailparticulier VARCHAR(32) NOT NULL, ADD adresseparticulier VARCHAR(255) DEFAULT NULL, ADD mailtest VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE particulier DROP mailparticulier, DROP adresseparticulier, DROP mailtest');
    }
}
